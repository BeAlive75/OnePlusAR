...
class GoogleMapGeoObjectPlugin implements GeoObjectPlugin {
	...
	public GoogleMapGeoObjectPlugin(GoogleMapWorldPlugin worldGoogleMapPlugin, OnePlusARObject oneplusarObject) {
		mAttached = false;
		...
		setOnePlusARObject(oneplusarObject);
	}

	/**
	 * Setup the plugin according to the OnePlusARObject
	 * 
	 * @param OnePlusARObject
	 */
	private void setOnePlusARObject(OnePlusARObject oneplusarObject) {
		if (oneplusarObject instanceof GeoObject) {
			mGeoObject = (GeoObject) oneplusarObject;
		} else {
			// throw new
			// IllegalArgumentException("oneplusarObject must be a GeoObject");
		}
		if (mGeoObject == null) {
			throw new NullPointerException("The OnePlusARObject must not be null");
		}
		mAttached = true;
	}
	...
	/**
	 * Get the {@link LatLng} instance that represents the {@link com.oneplusar.android.world.GeoObject GeoObject}. It
	...
	/**
	 * Set the {@link Marker} that belongs to the {@link com.oneplusar.android.world.GeoObject GeoObject}
	 * 
	 * @param marker
	 */
	...
	/**
	 * Get the marker that belongs to the {@link com.oneplusar.android.world.GeoObject GeoObject}
	 * 
	 * @return
	 */
