...
public interface GLPlugin extends Plugin {
	...
	/**
	 * Called before a {@link com.oneplusar.android.world.OnePlusARObject
	 * OnePlusARObject} is rendered.
	 * 
	 * @param gl
	 * @param oneplusarObject
	 *            the {@link com.oneplusar.android.world.OnePlusARObject
	 *            OnePlusARObject} to be rendered.
	 * @param defaultTexture
	 *            The default texture to draw if the
	 *            {@link com.oneplusar.android.world.OnePlusARObject
	 *            OnePlusARObject}'s
	 *            {@link com.oneplusar.android.opengl.texture.Texture Texture} is
	 *            not loaded.
	 */
	public void onDrawBeyondaarObject(GL10 gl, OnePlusARObject oneplusarObject, Texture defaultTexture);
