 ...
 */
package com.oneplusar.android.util;
...
public class ImageUtils {
	 ...
	 * to a {@link com.oneplusar.android.world.OnePlusARObject OnePlusARObject}. Remember that in order to use this feature
	...
	/**
	 * Save the view in the the storage. This can be used to set a static view
	 * to a {@link OnePlusARObject#}. Remember that in order to use this feature
	 * you may need to set {@link Manifest.permission#WRITE_EXTERNAL_STORAGE}
	 * permission in your application manifest.<br>
	 * 
	 * This method uses PNG compression.
