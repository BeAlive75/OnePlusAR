 ...
 */
package com.oneplusar.android.util.location;
 ...
 * <br>
 * Here is a small example how to use {@link OnePlusARLocationManager}: <br>
 * 
 * <pre>
 * <code>
 * void onCreate(Bundle savedInstanceState){
 * 	OnePlusARLocationManager.setLocationManager((LocationManager) this.getSystemService(Context.LOCATION_SERVICE));
 * 	OnePlusARLocationManager.addGeoObjectLocationUpdate(oneplusarObject);
 * 	// You also can register a World or a LocationListener
 * 	// Don't forget to remove the object that you register
 * }
 * void onResume(){
 * 	OnePlusARLocationManager.enable();
 * }
 * 
 * void onPause(){
 * 	OnePlusARLocationManager.disable();
 * }
 * </code>
 * </pre>
 */
public class OnePlusARLocationManager {

	public final static int MAX_TIME_GPS_FIX = 20000;

	private OnePlusARLocationManager() {
	}

	private static enum OnePlusARLocationManagerSingleton {
		INSTANCE;

		private LocationManager mLocationManager;
		private OnePlusARLocation mLocationListener;
		private OnePlusARGpsListener mGpsListener;
		private boolean mIsEnabled;
		private boolean mGpsFix;

		private OnePlusARLocationManagerSingleton() {
			mLocationListener = new OnePlusARLocation();
			mGpsListener = new OnePlusARGpsListener();
			mIsEnabled = false;
			mGpsFix = false;
		}
		...
		private class OnePlusARGpsListener implements GpsStatus.Listener {
	...
	public static void setLocationManager(LocationManager locationManager) {
		...
		OnePlusARLocationManagerSingleton.INSTANCE.setLocationManager(locationManager);
	}

	/**
	 * Add a {@link com.oneplusar.android.world.GeoObject GeoObject} that will be
	 * updated with the user location.
	 * 
	 * @param geoObject
	 */
	public static void addGeoObjectLocationUpdate(GeoObject geoObject) {
		OnePlusARLocationManagerSingleton.INSTANCE.mLocationListener.addGeoObjectLocationUpdate(geoObject);
	}

	/**
	 * Remove the specified {@link com.oneplusar.android.world.GeoObject
	...
	public static void removeGeoObjectLocationUpdate(GeoObject geoObject) {
		OnePlusARLocationManagerSingleton.INSTANCE.mLocationListener.removeGeoObjectLocationUpdate(geoObject);
	}

	/**
	 * Remove all the {@link com.oneplusar.android.world.GeoObject GeoObject} to
	 * get the location updates.
	 */
	public static void removeAllGeoObjectsUpdates() {
		OnePlusARLocationManagerSingleton.INSTANCE.mLocationListener.removeAllGeoObjectsUpdates();
	}
	...
	public static void addWorldLocationUpdate(World world) {
		OnePlusARLocationManagerSingleton.INSTANCE.mLocationListener.addWorldLocationUpdate(world);
	}
	...
	public static void removeWorldLocationUpdate(World world) {
		OnePlusARLocationManagerSingleton.INSTANCE.mLocationListener.removeWorldLocationUpdate(world);
	}
	...
	public static void removeAllWorldsUpdates() {
		OnePlusARLocationManagerSingleton.INSTANCE.mLocationListener.removeAllWorldsUpdates();
	}
	...
	public static void addLocationListener(LocationListener locationListener) {
		OnePlusARLocationManagerSingleton.INSTANCE.mLocationListener.addLocationListener(locationListener);
	}
	...
	public static void removeLocationListener(LocationListener locationListener) {
		OnePlusARLocationManagerSingleton.INSTANCE.mLocationListener.removeLocationListener(locationListener);
	}
	...
	public static void removeAllLocationListener() {
		OnePlusARLocationManagerSingleton.INSTANCE.mLocationListener.removeAllLocationListener();
	}
	...
	public static void enable() {
		OnePlusARLocationManagerSingleton.INSTANCE.enable();
	}
	...
	public static void disable() {
		OnePlusARLocationManagerSingleton.INSTANCE.disable();
	}
	...
	public static boolean isEnabled() {
		return OnePlusARLocationManagerSingleton.INSTANCE.isEnabled();
	}
	...
	public static boolean gpsFix() {
		return OnePlusARLocationManagerSingleton.INSTANCE.gpsFix();
	}
}
