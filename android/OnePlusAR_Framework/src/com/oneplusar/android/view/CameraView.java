...
import com.oneplusar.android.util.DebugBitmap;
import com.oneplusar.android.util.GoogleGlassUtils;
...
public class CameraView extends SurfaceView implements SurfaceHolder.Callback, Camera.PictureCallback {
	 ...
	 * 
	 */
	public static interface OnePlusARPictureCallback {
		/**
	...
	private OnePlusARPictureCallback mCameraCallback;
	 ...
	 * {@link com.oneplusar.android.view.OnePlusARGLSurfaceView.OnePlusARPictureCallback
	 * OnePlusARPictureCallback} to get notify when the picture is ready.
	 * 
	 ...
	 *            Bitmap options.
	 */
	public void takePicture(OnePlusARPictureCallback cameraCallback, BitmapFactory.Options options) {
		if (mCamera == null) {
			return;
		}
