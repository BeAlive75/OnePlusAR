...
public class CustomWorldHelper {
	...
	public static World generateObjects(Context context) {
		...
		sharedWorld.setDefaultImage(R.drawable.oneplusar_default_unknow_icon);
		...
		go2.setImageUri("http://oneplusar.github.io/oneplusar/images/logo_512.png");
		...
		sharedWorld.addOnePlusARObject(go1);
		sharedWorld.addOnePlusARObject(go2, LIST_TYPE_EXAMPLE_1);
		sharedWorld.addOnePlusARObject(go3);
		sharedWorld.addOnePlusARObject(go4);
		sharedWorld.addOnePlusARObject(go5);
		sharedWorld.addOnePlusARObject(go6);
		sharedWorld.addOnePlusARObject(go7);
		sharedWorld.addOnePlusARObject(go8);
		sharedWorld.addOnePlusARObject(go9);
		sharedWorld.addOnePlusARObject(go10);
