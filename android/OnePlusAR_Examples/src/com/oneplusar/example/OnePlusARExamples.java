...
public class OnePlusARExamples extends Activity implements OnItemClickListener {

	private ListView mLisViewt;
	private String[] values = new String[] { "Simple AR camera",
			"Simple camera with a max/min distance far for rendering", "OnePlusAR World in Google maps",
			...
			"Using OnePlusARLocationManager" };
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int pos, long arg3) {
		...
		case 10:
			...
			break;
		case 11:
			openActivity(OnePlusARLocationManagerMapActivity.class);
			break;
		default:
			break;
		}
